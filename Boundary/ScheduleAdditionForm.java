...
public class ScheduleAdditionForm extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 화면에 표시된 캘린더뷰에서 선택한 날짜를 "이벤트시작날짜"로 지정해주는 코드
        ...
        mStartTimeTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog dialog = new TimePickerDialog(
                        ScheduleAdditionForm.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int saved = scheduleController.addSchedule(TITLE, PLACE, MEMO, PRIORITY,
                        START_DATE, START_TIME, END_DATE, END_TIME, mScheduleID);
                if (saved == -1) {
                    Toast.makeText(ScheduleAdditionForm.this,
                            "저장에 문제가 발생하였습니다", Toast.LENGTH_SHORT).show();
                } else if (saved == 0) {
                    Toast.makeText(ScheduleAdditionForm.this,
                            "일정이 저장되었습니다", Toast.LENGTH_SHORT).show();
                    setResult(RESULT_OK);
                }
                onBackPressed();
            }
